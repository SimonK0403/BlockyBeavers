...
public class BeaverEntityModel extends QuadrupedEntityModel<LivingEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild(
                ...
                ModelPartBuilder.create().uv(19, 21).cuboid(-2.0F, -2.0F, -5.0F, 4.0F, 4.0F, 5.0F, dilation),
                ModelTransform.origin(0.0F, 18.0F, -5.0F)
        );

        modelPartData.addChild(
                EntityModelPartNames.BODY,
                ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -3.0F, -5.0F, 8.0F, 6.0F, 10.0F, dilation), ModelTransform.origin(0.0F, 20.0F, 0.0F)
        );

        modelPartData.addChild(
                EntityModelPartNames.RIGHT_FRONT_LEG,
                ModelPartBuilder.create().uv(0, 5).cuboid(0.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, dilation),
                ModelTransform.origin(3.0F, 21.0F, -5.0F)
        );

        modelPartData.addChild(
                EntityModelPartNames.LEFT_FRONT_LEG,
                ModelPartBuilder.create().uv(0, 0).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, dilation),
                ModelTransform.origin(-4.0F, 21.0F, -5.0F)
        );

        modelPartData.addChild(
                EntityModelPartNames.RIGHT_HIND_LEG,
                ModelPartBuilder.create().uv(26, 0).cuboid(-1.0F, -1.0F, -3.0F, 2.0F, 3.0F, 4.0F, dilation),
                ModelTransform.origin(4.0F, 22.0F, 4.0F)
        );

        modelPartData.addChild(
                EntityModelPartNames.LEFT_HIND_LEG,
                ModelPartBuilder.create().uv(0, 26).cuboid(-1.0F, -1.0F, -3.0F, 2.0F, 3.0F, 4.0F, dilation),
                ModelTransform.origin(-4.0F, 22.0F, 4.0F)
        );

        modelPartData.addChild(
                EntityModelPartNames.TAIL,
                ModelPartBuilder.create().uv(0, 16).cuboid(-2.0F, -1.0F, 0.0F, 4.0F, 2.0F, 8.0F, dilation),
                ModelTransform.origin(0.0F, 22.0F, 5.0F)
        );
    ...
    public void setAngles(LivingEntityRenderState livingEntityRenderState) {
        ...
        float limbFrequency = livingEntityRenderState.limbSwingAnimationProgress;
        float limbAmplitudeMultiplier = livingEntityRenderState.limbSwingAmplitude;
